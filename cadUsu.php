<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        $result = mysqli_query($conexao, "INSERT INTO usuarios (cpf,nome,email,telefone,sexo,dataNascimento,senha,cidade,bairro,endereco,numEndereco,ativo) 
        VALUES ('$cpf','$nome','$email','$telefone','$sexo','$dataNascimento', '$senha','$cidade','$bairro','$endereco','$numEndereco','$ativo')");

        header('Location: cadUsuSalvo.php');
    }
    ...
    <div class="box">
        <form action="cadUsu.php" method="POST">
            <fieldset>
                ...
                <p>Ativo:</p>
                    <input type="radio" id="ativo" name="ativo" value="S" required>
                    <label for="ativo">Ativo</label>            
                    <input type="radio" id="inativo" name="ativo" value="N" required>

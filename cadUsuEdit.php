<?php
    ...
    if(!empty($_GET['id']))
    {
        ...
        {
            header('Location: sistemaUsu.php');
        }
    }
    else
    {
...
<!--    <a href="home.php">Voltar</a>   -->
    <div class="box">
        <form action="cadUsuSaveEdit.php" method="POST">
            <fieldset>
                <legend><b>Editar Usuário</b></legend>                
                <p>Ativo:</p>
                    <input type="radio" id="ativo" name="ativo" value="S" <?php echo ($ativo == 'S') ? 'checked' : '';?> required>
                    <label for="ativo">Ativo</label>            
                    <input type="radio" id="inativo" name="ativo" value="N" <?php echo ($ativo == 'N') ? 'checked' : '';?> required>
